GenerateCode() {
    ...
    If (ToolbarExist()) {
        ...
        Code .= Indent . "hToolbar := Toolbar_Add(hWnd, ""OnToolbar"", """ . Toolbar.Options . """, ImageList)" . CRLF
        ...
        Code .= Indent . "Buttons = " . CRLF . Indent . "(LTrim" . CRLF . ToolbarButtons . Indent . ")" . CRLF
        Code .= Indent . "Toolbar_Insert(hToolbar, Buttons)" . CRLF
        If (InStr(Toolbar.Options, "Vertical")) {
            Code .= Indent . "Toolbar_Autosize(hToolbar, ""bl"") `; Vertical" . CRLF
        }
        Code .= "}" . CRLF . CRLF
        Code .= "OnToolbar(hWnd, Event, Text, Pos, Id) {" . CRLF
        Code .= Indent . "If (Event = ""Hot"") {" . CRLF . Indent . Indent . "Return" . CRLF . Indent . "}" . CRLF . "}" . CRLF
    }

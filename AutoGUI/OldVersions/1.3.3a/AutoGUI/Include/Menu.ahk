...
AddMenu("AutoControlMenu", "Select &All", "SelectAll", IconLib, 41)
Menu AutoControlMenu, Add
...
;AddMenu("AutoRunMenu", "From the Saved &Location`tCtrl+F9", "RunScript", IconLib, 93)
;AddMenu("AutoRunMenu", "&Through a Named Pipe`tAlt+F9", "RunScript", IconLib, 94)
...
AddMenu("AutoOptionsMenu", "&Indentation Guides", "ToggleIndentGuides")

...
ShowCloneDialog:
    ...
    SetWindowIcon(hCloneDlg, "Icons\WCT.ico")
    ...
    Gui Add, CheckBox, vIncludeStyles x112 y306 w210 h23, Include styles for all controls in output
    Gui Add, StatusBar,, %A_Space%%A_Space%%A_Space%Notice: This tool does not retrieve variables and named styles associated with the controls.

...
Sci.StyleSetFont(SCE_AHKL_NEUTRAL, "Lucida Console", 2)
...
Sci.StyleSetFont(SCE_AHKL_USERDEFINED1, "Lucida Console", 2)
...
CreateScintilla(hParent, x, y, w, h, SciLexer, Style := "0x50010000", ExStyle := 0x200) {
    ...
    Scintilla.StyleSetFont(SCE_AHKL_NEUTRAL, "Lucida Console", 2)

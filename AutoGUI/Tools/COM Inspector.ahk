...
Menu HelpMenu, Add, COM Object Reference, OnlineRef
Menu HelpMenu, Add
...
Gui Add, ComboBox, hWndhCbxSearch vKeyword gSearch x10 y456 w180
Gui Add, Text, vLblSearch x207 y456 w64 h23 +0x200, Search in:
Gui Add, CheckBox, vChkCLSID gSearch x275 y456 w64 h23 +Checked, CLSID
Gui Add, CheckBox, vChkProgID gSearch x344 y456 w68 h23 +Checked, ProgID
Gui Add, CheckBox, vChkDesc gSearch x418 y456 w87 h23 +Checked, Description
Gui Add, CheckBox, vChkRegEx gSearch x516 y456 w158 h23, Using Regular Expression
...
If (hEdit := DllCall("GetWindow", "Ptr", hCbxSearch, "UInt", GW_CHILD := 5)) {

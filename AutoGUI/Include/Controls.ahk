...
Default.StatusBar    := New DefControl("Status Bar", "", "", "", "=", IconLib, 65)
...
Default.ComboBox.Menu := ["Alternate Submit", "Sort Alphabetically", "Uppercase All Items", "Lowercase All Items", "Simple (Edit + ListBox)", "Hint Text...", "Disabled"]
...
Default.Edit.Menu     := ["Read Only", "Multiline", "No Scrollbar", "Numbers Only", "Password Field", "Hint Text...", "Disabled"]
...
Default.ListView.Menu := ["Alternate Submit", "No Column Header", "Show Checkboxes", "Show Grid", "Single Row Selection", "Show ToolTips", "Sort Alphabetically", "No Sort Header", "Editable First Cell", "Underline Hot Items", "Prevent Flicker", "Explorer Theme", "Disabled"]
...
Default.Text.Menu     := ["Single Line", "Show Border", "Sunken", "3D Sunken Edge", "3D Outset Border", "Disabled"]

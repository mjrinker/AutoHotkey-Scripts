...
ShowReplaceDialog:
    If (WinExist("ahk_id " . hFindReplaceDlg)) {
        ...
        SetWindowIcon(hFindReplaceDlg, IconLib, 83)
...
FindReplaceTabHandler:
    ...
    If (FindReplaceTab == 2) {
        ...
        SetWindowIcon(hFindReplaceDlg, IconLib, 84)
...
Replace:
    ...
    If (A_ThisLabel == "FindNext") {
        If (g_RegExFind) {
            ...
            Sci[n].GetText(Sci[n].GetLength() + 1, SciText)
            Sci[n].GetTextRange([0, Sci[n].GetCurrentPos()], TempText)
        ...
        If (g_RegExFind) {
            Sci[n].GetText(Sci[n].GetLength() + 1, SciText)
            Sci[n].GetText(Sci[n].GetLength() + 1, SciText)
            Sci[n].GetTextRange([0, Sci[n].GetAnchor()], TempText)
...
MarkAll:
    ...
    If (g_RegExFind) {
        ...
        While (Sci[n].SearchInTarget(StringLength, "" . SearchString, 2) != -1) {

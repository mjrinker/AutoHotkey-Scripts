ShowToolsDialog:
    Gui ToolsDlg: New, +LabelToolsDlg +hWndhToolsDlg +OwnerAuto
    ...
    Gui Add, Edit, vToolTitle gUpdateToolTitle x100 y240 w281 h21 Disabled
    ...
    Loop % Tools.Length() {
        ...
        Loop % Tools.Length() {
            ...
            If (Tools[i].Title == Tools[A_Index].Title) {
                Gui +OwnDialogs
                MsgBox 0x30, Configure Tools
                , % "The title must be unique. More than one tool has the title """ . Tools[i].Title . """."
                Return
            }
        }
    }
